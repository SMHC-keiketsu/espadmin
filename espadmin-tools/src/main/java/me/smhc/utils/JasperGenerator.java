package invoice.invoice_aiinside;
...
public class MyJasperGenerator {
     ...
     * @return
     */
    public JRDataSource makeBeansDataSource(Collection<?> beanCollection) {

        JRDataSource res = new JRBeanCollectionDataSource(beanCollection);
        return res;
    }
    /**
