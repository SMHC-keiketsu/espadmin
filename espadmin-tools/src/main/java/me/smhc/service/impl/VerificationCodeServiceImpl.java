...
import me.smhc.repository.VerificationCodeRepository;
...
public class VerificationCodeServiceImpl implements VerificationCodeService {
    ...
    public EmailVo sendEmail(VerificationCode code) {
        ...
        if(verificationCode == null){
            ...
            emailVo = new EmailVo(Collections.singletonList(code.getValue()),"espadmin后台管理系统",content);
        ...
        // 存在就再次发送原来的验证码
            ...
            emailVo = new EmailVo(Collections.singletonList(verificationCode.getValue()),"espadmin后台管理系统",content);
        }
        return emailVo;
    }
