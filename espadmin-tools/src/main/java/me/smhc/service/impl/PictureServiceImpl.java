...
import me.smhc.domain.Picture;
import me.smhc.repository.PictureRepository;
import me.smhc.service.PictureService;
import me.smhc.service.dto.PictureQueryCriteria;
...
public class PictureServiceImpl implements PictureService {
    ...
    public Picture upload(MultipartFile multipartFile, String username) {
        ...
        // 上传文件
        String result= HttpRequest.post(EspadminConstant.Url.SM_MS_URL + "/v2/upload")
    ...
    public void synchronize() {
        //链式构建请求
        String result = HttpRequest.get(EspadminConstant.Url.SM_MS_URL + "/v2/upload_history")
                //头信息，多个头信息多次调用此方法即可
                .header("Authorization", token)
                .timeout(20000)
                .execute().body();
