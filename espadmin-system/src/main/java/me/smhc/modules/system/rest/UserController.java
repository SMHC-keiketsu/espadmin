package me.smhc.modules.system.rest;
...
import me.smhc.modules.system.domain.vo.UserPassVo;
...
public class UserController {
    ...
    public ResponseEntity<Object> updateEmail(@PathVariable String code,@RequestBody User user){
        ...
        VerificationCode verificationCode = new VerificationCode(code, EspadminConstant.RESET_MAIL,"email",user.getEmail());
