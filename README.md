<h1 style="text-align: center">ESP-ADMIN 后台管理系统</h1>
...
- espadmin-common 公共模块
    ...
    - exception 项目统一异常的处理
    - utils 系统通用工具类
- espadmin-system 系统核心模块（系统启动入口）
	- config 配置跨域与静态资源，与数据权限
	    - thread 线程池相关
	- modules 系统相关模块(登录授权、系统监控、定时任务等)
- espadmin-logging 系统日志模块
- espadmin-tools 系统第三方工具模块
- espadmin-generator 系统代码生成模块
