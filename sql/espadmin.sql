...
-- ----------------------------
INSERT INTO `gen_config` VALUES (3, 'gen_test', 'Zheng Jie', b'1', 'espadmin-system', 'me.smhc.gen', 'E:\\workspace\\me\\front\\espadmin-web\\src\\views\\gen', 'E:\\workspace\\me\\front\\espadmin-web\\src\\api', NULL, '测试生成');
-- ----------------------------
...
-- Records of mnt_app
-- ----------------------------
INSERT INTO `mnt_app` VALUES (1, 'espadmin-monitor-2.4.jar', '/opt/upload', '/opt/monitor', '/opt/backup', 8777, 'cd /opt/monitor\nnohup java -jar espadmin-monitor-2.4.jar >nohup.out 2>&1 &', 'mv -f /opt/upload/espadmin-monitor-2.4.jar /opt/monitor\ncd /opt/monitor\nnohup java -jar espadmin-monitor-2.4.jar >nohup.out 2>&1 &', '2019-11-24 20:52:59');
INSERT INTO `mnt_app` VALUES (2, 'espadmin-system-2.3.jar', '/opt/upload', '/opt/espadmin', '/opt/backup/espadmin', 8000, 'cd /opt/espadmin\nnohup java -jar espadmin-system-2.3.jar --spring.profiles.active=prod >nohup.out 2>&1 &', 'mv -f /opt/upload/espadmin-system-2.3.jar /opt/espadmin/\ncd /opt/espadmin\nnohup java -jar espadmin-system-2.3.jar --spring.profiles.active=prod >nohup.out 2>&1 &', '2019-12-21 16:39:57');
...
-- ----------------------------
INSERT INTO `mnt_database` VALUES ('c4109eefc5724c65857ca9dd2690e0dd', 'espadmin', 'jdbc:mysql://localhost:3306/espadmin?serverTimezone=Asia/Shanghai', 'root', '123456', '2019-12-21 21:11:17');
...
-- ----------------------------
INSERT INTO `mnt_deploy_history` VALUES ('4ee0edd1f3b648a396280a542d72c121', 'espadmin-monitor-2.4.jar', '2019-12-22 13:06:07', 'admin', '132.232.129.20', 3);
INSERT INTO `mnt_deploy_history` VALUES ('4fd432a128c947ccae55316b3d5dcd7b', 'espadmin-monitor-2.4.jar', '2019-12-22 13:49:09', 'admin', '132.232.129.20', 3);
INSERT INTO `mnt_deploy_history` VALUES ('cfda21f48da341b396657af94554c890', 'espadmin-monitor-2.4.jar', '2019-12-22 13:08:22', 'admin', '132.232.129.20', 3);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, NULL, 'smhc@tom.com', 1, '$2a$10$fP.426qKaTmix50Oln8L.uav55gELhAd0Eg66Av4oG86u8km7D/Ky', 'admin', 2, '18888888888', 11, '2018-08-23 09:11:56', '2019-05-18 17:34:21', '管理员', '男');
INSERT INTO `user` VALUES (3, NULL, 'test@espadmin.net', 1, '$2a$10$HhxyGZy.ulf3RvAwaHUGb.k.2i9PBpv4YbLMJWp8pES7pPhTyRCF.', 'test', 2, '17777777777', 12, '2018-12-27 20:05:26', '2019-04-01 09:15:24', '测试', '男');
